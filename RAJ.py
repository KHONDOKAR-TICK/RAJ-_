...
\033[1;91m☞ Auther     : KHONDKAR -RAJ
\033[1;92m☞ WhatsApp   : 0316577116
\033[1;95m☞ FACEBOOK     : https://www.facebook.com/Khondokar.rahim73
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/KHONDOKAR-TICK')
	    os.system('cd $HOME && git clone https://github.com/KHONDOKAR-TICK/RAJ-_')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To KHONDOKAR-TICK')
	    psb('Congratulations KHONDOKAR-TICK  Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ lagbena✓')
	    psb('🔓Password ☆ lagbena✓')
	    psb('Subscrib My Facebook  account Khondokar.rahim73 ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/KHONDOKAR-TICK && python2 RAJ.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/Khondokar.rahim73')
	    menu()
	elif bm =='4':
